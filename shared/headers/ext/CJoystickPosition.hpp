...
#define JOYSTICK_X_MIN 4 ///< Minimum joystick analog x value
#define JOYSTICK_X_MAX 4034 ///< Maximum joystick analog x value

#define JOYSTICK_Y_MIN 4 ///< Minimum joystick analog x value
#define JOYSTICK_Y_MAX 4096 ///< Maximum joystick analog x value
